...
const translationsEN = {
    ...
    'programs-description': 'Scalar School was founded to address a real need in training early-stage Bitcoin developers: establishing a solid theoretical foundation in an inclusive learning environment for women. We offer high-quality training for beginner Bitcoin developers, with a curriculum based on the best technical programs in the world, such as Base58, Chaincode Labs, Bitshala, Learning Bitcoin from the Command Line, and canonical textbooks. Additionally, Scalar School actively fosters community growth and strength by hosting developer meetups like Bitdevs Ribeirão Preto. We provide the foundational knowledge. You choose your path.',
